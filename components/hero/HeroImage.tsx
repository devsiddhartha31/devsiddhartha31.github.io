...
export default function HeroImage() {
  return (
    <div className="flex justify-start md:justify-end">
      <div className="relative w-full max-w-92 md:max-w-lg">
        {/* Glow */}
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-900/80 backdrop-blur-xl shadow-2xl">
          {/* Image */}
          <div className="relative h-68 md:h-100 overflow-hidden">
            <Image
          ...
          <div className="p-6">
            ...
            <p className="mt-2 text-xs md:text-sm text-zinc-400 overflow-hidden text-ellipsis">
              {profile.headline}
            </p>
